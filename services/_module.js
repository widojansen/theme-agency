...
function create_fragment$2(ctx) {
	...
	return {
		...
		h() {
			...
			attr(div3, "id", "section-527bd59e-5af7-44f6-9301-20dc72f7a72b");
		},
		m(target, anchor) {
...
function create_fragment$3(ctx) {
	...
	return {
		...
		h() {
			...
			attr(div2, "id", "section-4c197c1a-76b0-4b6b-a744-6d812e9d674e");
		},
		m(target, anchor) {
...
class Component$3 extends SvelteComponent {
	constructor(options) {
		super();
		init(this, options, instance$2, create_fragment$3, safe_not_equal, { heading: 0, items: 1, variation: 2 });
	}
}
...
function create_fragment$4(ctx) {
	...
	return {
		...
		h() {
			...
			attr(div1, "class", "component");
			attr(div2, "class", "section");
			attr(div2, "id", "section-3569ddfa-2635-4f1b-b197-fb5acfefacbb");
		},
		m(target, anchor) {
			insert_hydration(target, div2, anchor);
			append_hydration(div2, div1);
				...
				items: [
					{
						"title": "Design",
						"description": {
							"html": "<p>Sagittis nisl rhoncus mattis rhoncus urna neque viverra justo. Pellentesque dignissim enim sit amet venenatis urna cursus.</p>",
							"markdown": "Sagittis nisl rhoncus mattis rhoncus urna neque viverra justo. Pellentesque dignissim enim sit amet venenatis urna cursus.\n\n"
						}
					},
					{
						"title": "Development",
						"description": {
							"html": "<p>Aenean pharetra magna ac placerat vestibulum lectus mauris ultrices.</p>",
							"markdown": "Aenean pharetra magna ac placerat vestibulum lectus mauris ultrices.\n\n"
						}
					},
					{
						"title": "UX Architecting",
						"description": {
							"html": "<p>Elementum sagittis vitae et leo duis ut diam quam. Elementum sagittis vitae et leo duis ut diam quam.</p>",
							"markdown": "Elementum sagittis vitae et leo duis ut diam quam. Elementum sagittis vitae et leo duis ut diam quam.\n\n"
						}
					},
					{
						"title": "Occaecat eiusmod mollit",
						"description": {
							"html": "<p>Pellentesque dignissim enim sit amet venenatis urna cursus. Ornare lectus sit amet est placerat.</p>",
							"markdown": "Pellentesque dignissim enim sit amet venenatis urna cursus. Ornare lectus sit amet est placerat.\n\n"
						}
					},
					{
						"title": "Enim aute lorem",
						"description": {
							"html": "<p>Pellentesque dignissim enim sit amet venenatis urna cursus. Ornare lectus sit amet est placerat.</p>",
							"markdown": "Pellentesque dignissim enim sit amet venenatis urna cursus. Ornare lectus sit amet est placerat.\n\n"
						}
	...
	component_3 = new Component$4({
			props: {
				image: {
					...
					"url": "https://images.unsplash.com/photo-1556761175-4b46a572b786?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1674&q=80",
					"size": null
				}
			}
		});
